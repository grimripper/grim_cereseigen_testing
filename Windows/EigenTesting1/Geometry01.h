...
Transform<double,3, Affine> GetTransform(double angle_in_degrees_around_y, double tx, double ty, double tz)
{
...
void run()
{
    Transform<double, 3, Affine> transform_y_30_deg_1_0_0 = GetTransform(30, 1, 1, 1);
